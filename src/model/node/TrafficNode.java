...
public abstract class TrafficNode {
    ...
    public void addRoad(Road newRoad){
        ...
        for(Road road : roadList){
            ...
            if(centerPoint.distanceTo(rightWay.getLaneList().get(0).getStartPoint()) //Right way is entry way
                > centerPoint.distanceTo(leftWay.getLaneList().get(0).getStartPoint())){
        ...
        Way newExitWay;
        //decide which way is entry way and which way is exit way by the distance from center point to start point of each way
        if(centerPoint.distanceTo(newRoad.getRightWay().getLaneList().get(0).getStartPoint()) //Right way is entry way
				> centerPoint.distanceTo(newRoad.getLeftWay().getLaneList().get(0).getStartPoint())){
    ...
    public void removeRoad(Road roadToRemove){
    	...
    	Way exitWayToRemove;
    	//decide which way is entry way and which way is exit way by the distance from center point to start point of each way
		if(centerPoint.distanceTo(roadToRemove.getRightWay().getLaneList().get(0).getStartPoint()) //Right way is entry way
				> centerPoint.distanceTo(roadToRemove.getLeftWay().getLaneList().get(0).getStartPoint())){
