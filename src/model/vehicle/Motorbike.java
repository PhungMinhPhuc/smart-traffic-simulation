...
public class Motorbike extends Vehicle {
    public Motorbike(TrafficPoint position, TrafficVector direction, DriverBehavior behavior) {
	   super("Motorbike", Constants.MOTORBIKE_MAX_SPEED, Constants.MOTORBIKE_LENGTH, Constants.MOTORBIKE_WIDTH, Constants.MOTORBIKE_SOUND, Constants.MOTORBIKE_COLOR,
